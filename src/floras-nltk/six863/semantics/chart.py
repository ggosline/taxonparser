        ...
        while edges_added > 0:
            ...
            for rule in self._strategy:
                ...
                if self._trace == 1 and edges_added_by_rule > 0:
                    print
                    '  - Added %d edges' % edges_added_by_rule
    ...
    def step(self):
        ...
        while 1:
            ...
            for e in self._parse():
                if self._trace > 1: print
                self._current_chartrule
                if self._trace > 0: print
                self._chart.pp_edge(e, w)
                yield e
...
def demo():
    ...
    '  3: Earley parser'
    print
    '  4: Stepping chart parser (alternating top-down & bottom-up)'
    print
    '  5: All parsers'
    print
    '\nWhich parser (1-5)? ',
